...
@property (nullable, nonatomic, retain) NSSet<WastePile *> *plotPile;
...
- (void)addPlotPileObject:(WastePile *)value;
- (void)removePlotPileObject:(WastePile *)value;
- (void)addPlotPile:(NSSet<WastePile *> *)values;
- (void)removePlotPile:(NSSet<WastePile *> *)values;
