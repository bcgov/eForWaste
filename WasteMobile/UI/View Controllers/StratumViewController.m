...
@synthesize wasteBlock, wasteStratum, plotTableView, aggregatePlotTableView, sortColumn, sortLicense, sortCuttingPermit, sortCutblock;
...
- (void) populateFromObject{
    ...
    */
    ...
    if ([self.wasteStratum.isPileStratum intValue] == 1) {
        [self.wasteType setEnabled:NO];
        [self.addPlotButton setHidden:YES];
    }
