...
-(IBAction) doneEdit:(id)sender{
   ...
   /* int total = 0;
    int ce = [[self.wastePile valueForKey:@"cePercent"] intValue];
    int he = [[self.wastePile valueForKey:@"hePercent"] intValue];
    int sp = [[self.wastePile valueForKey:@"spPercent"] intValue];
    int ba = [[self.wastePile valueForKey:@"baPercent"] intValue];
    int co = [[self.wastePile valueForKey:@"coPercent"] intValue];
    int lo = [[self.wastePile valueForKey:@"loPercent"] intValue];
    int bi = [[self.wastePile valueForKey:@"biPercent"] intValue];
    total += ce + he + sp + ba + co + lo + bi;*/
